...
class LogWriter {
   ...
   * @param {Object} options.server объект сервера на который отправляются запросы
   * @param {String} listRegs список регистров для записи в файл
   */
  constructor(options) {
    var trace = 1,
    ...
    // строка заголовка файла (список регистров) с разделителем \t
    this.headers =

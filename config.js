...
entities.push({
  ...
  regs: {
    "1-T": {
      ...
      legend: "Зона1.Темп.", // Надпись для графика
    },
    "2-T": {
      // реальный адрес регистра, по которому нужно делать запрос
      ...
      legend: "Зона2.Темп.", // Надпись для графика
    },
    "3-T": {
      // реальный адрес регистра, по которому нужно делать запрос
      ...
      legend: "Зона3.Темп.", // Надпись для графика
    },
    "4-T": {
      // реальный адрес регистра, по которому нужно делать запрос
      ...
      legend: "Зона4.Деталь.Темп.", // Надпись для графика
    },
  }, //regs
  listRegs: "1-T;2-T;3-T;4-T", // список регистров для запроса, что бы их не генерировать каждый раз
});
...
config.queue.work = ["1-T", "2-T", "3-T", "4-T"];

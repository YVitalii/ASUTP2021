...
entities.push({
  ...
  ,listRegs:"1-T;2-T;1-SP;2-SP" // список регистров для запроса, что бы их не генерировать каждый раз
});
...
config.logger={
  ...
  ,period:5 // период между записями 30 секунд
...
config.queue.work=["1-T","2-T","3-T","1-SP","2-SP"];
